...
strategy_to_params_configs = {
        ...
        '接力-一进二弱转强:倒接力5': {
                "per_step_tick_gap": 1,
                "cold_start_steps": 1,
                "max_abserve_tick_steps": 518,
                "max_abserce_avg_price_down_steps": 9,
                "stop_profit_open_hc_pct": -0.030455353882053695,
                "dynamic_hc_stop_profit_thres": 1.7647436420442868,
                "last_close_price_hc_pct": 0.004425809406460694,
                "last_day_sell_thres": 0.6431636735388522,
                "last_day_sell_huiche": 0.004395759696349707,
                "fd_mount": 133516457,
                "fd_vol_pct": 0.444472657710759,
                "fd_ju_ticks": 1,
                "max_zb_times": 1,
                "stagnation_kline_ticks": 35,
                "decline_kline_ticks": 50,
                "yang_yin_threshold": 0.008816610765882506,
                "stagnation_n": 24,
                "stagnation_volume_ratio_threshold": 50.694150888662065,
                "stagnation_ratio_threshold": 390,
                "decline_volume_ratio_threshold": 73.50320176182991,
                "max_rebounds": 12,
                "decline_ratio_threshold": 16,
                "flxd_ticks": 28,
                "flzz_ticks": 1164,
                "use_simiple_kline_strategy_flxd": False,
                "use_simiple_kline_strategy_flzz": True,
                "flzz_use_smooth_price": False,
                "flzz_zf_thresh": 0.03337804320948263,
                "kline_sell_flxd_zy": False,
                "kline_sell_flxd_zs": False,
                "kline_sell_flzz_zs": True,
                "kline_sell_flzz_zy": True,
                "last_open_price_hc_pct": 0.01,
                "open_price_max_hc": -0.015968564519676667,
                "loss_per_step_tick_gap": 1,
                "loss_cold_start_steps": 0,
                "loss_max_abserve_tick_steps": 416,
                "loss_max_abserce_avg_price_down_steps": 5,
                "loss_dynamic_hc_stop_profit_thres": 7.62553262834027,
                "loss_last_close_price_hc_pct": -0.048584407169245725,
                "loss_last_open_price_hc_pct": -0.05589456981308902,
                "loss_open_price_max_hc": -0.007248573113356099,
        ...
        '接力-一进二弱转强:接力倒接力3':{
                "per_step_tick_gap": 2,
                "cold_start_steps": 0,
                "max_abserve_tick_steps": 532,
                "max_abserce_avg_price_down_steps": 1,
                "stop_profit_open_hc_pct": -0.13720399265874342,
                "dynamic_hc_stop_profit_thres": 5.017412991792408,
                "last_close_price_hc_pct": 0.004702531580485953,
                "last_day_sell_thres": 0.43022382904285195,
                "last_day_sell_huiche": 0.005076260132841566,
                "fd_mount": 28176963,
                "fd_vol_pct": 0.5632557779937101,
                "fd_ju_ticks": 1,
                "max_zb_times": 1,
                "stagnation_kline_ticks": 32,
                "decline_kline_ticks": 13,
                "yang_yin_threshold": 0.014426417087827364,
                "stagnation_n": 26,
                "stagnation_volume_ratio_threshold": 73.53933024001836,
                "stagnation_ratio_threshold": 377,
                "decline_volume_ratio_threshold": 8.146062315667958,
                "max_rebounds": 2,
                "decline_ratio_threshold": 1327,
                "flxd_ticks": 480,
                "flzz_ticks": 1988,
                "use_simiple_kline_strategy_flxd": True,
                "use_simiple_kline_strategy_flzz": True,
                "flzz_use_smooth_price": True,
                "flzz_zf_thresh": 0.052493364441172766,
                "kline_sell_flxd_zy": True,
                "kline_sell_flxd_zs": False,
                "kline_sell_flzz_zs": False,
                "kline_sell_flzz_zy": True,
                "last_open_price_hc_pct": -0.004045366529156266,
                "open_price_max_hc": -0.017156982225920766,
                "loss_per_step_tick_gap": 23,
                "loss_cold_start_steps": 4,
                "loss_max_abserve_tick_steps": 334,
                "loss_max_abserce_avg_price_down_steps": 11,
                "loss_dynamic_hc_stop_profit_thres": 0.8373374619593243,
                "loss_last_close_price_hc_pct": -0.07939780205639835,
                "loss_last_open_price_hc_pct": -0.0027499385135565644,
                "loss_open_price_max_hc": -0.03620363749292904,
                "loss_down_open_sell_wait_time": True,
                "down_open_sell_wait_time": True,
                "stop_profit_pct": 0.0,
                "static_hc_stop_profit_pct": 1.0,
