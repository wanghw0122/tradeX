...
def create_strategy_table(prefix = "strategy_data_premarket_", specified_date = datetime.now().strftime("%Y%m")):
    ...
    columns = {
        ...
        #新增字段
        "xcjw_v2": "REAL DEFAULT 0.0",
        "jssb_v2": "REAL DEFAULT 0.0",
        "cjs_v2": "REAL DEFAULT 0.0",
        "is_strength_high": "INTEGER CHECK (is_strength_high IN (0, 1)) DEFAULT 0",
        "is_strength_middle": "INTEGER CHECK (is_strength_middle IN (0, 1)) DEFAULT 0",
        "is_strength_low": "INTEGER CHECK (is_strength_low IN (0, 1)) DEFAULT 0",
        "is_strength_increase": "INTEGER CHECK (is_strength_increase IN (0, 1)) DEFAULT 0",
        "is_strength_reduct": "INTEGER CHECK (is_strength_reduct IN (0, 1)) DEFAULT 0",
        "short_line_score": "REAL DEFAULT 0.0",
        "short_line_score_change": "REAL DEFAULT 0.0",
        "jsjl_block": "REAL DEFAULT 0.0",
        "jssb_block": "REAL DEFAULT 0.0",
        "cjs_block": "REAL DEFAULT 0.0",
        "direction_cjs_v2": "REAL DEFAULT 0.0",
        "circulation_market_value": "REAL DEFAULT 0.0",
        "cgyk": "TEXT DEFAULT ''",
        "htyk": "TEXT DEFAULT ''",
        "cgyk_value": "REAL DEFAULT 0.0",
        "htyk_value": "REAL DEFAULT 0.0",
        "is_middle_high_open": "INTEGER CHECK (is_middle_high_open IN (0, 1)) DEFAULT 0",
        "is_large_high_open": "INTEGER CHECK (is_large_high_open IN (0, 1)) DEFAULT 0",
